...
export default {
  ...
  auth: {
    ...
    sign_up: {
      header: {
        ...
        step: {
          ...
          password: {
            header: "Реєстрація",
            sub_header: "Зареєструйтеся, використовуючи комбінацію електронної пошти та пароля.",
          },
          unique_code: {
            header: "Реєстрація",
            sub_header:
              "Зареєструйтеся за допомогою унікального коду, надісланого на вказану вище адресу електронної пошти.",
          },
        },
      },
      errors: {
    ...
    sign_in: {
      header: {
        ...
        step: {
          email: {
            header: "Увійти або зареєструватися",
            sub_header: "",
          },
          password: {
            header: "Увійти або зареєструватися",
  ...
  timezone_setting: "Поточне налаштування часового поясу.",
  language_setting: "Виберіть мову інтерфейсу.",
  language_and_time: "Мова та час",
  settings_moved_to_preferences: "Налаштування часу та мови перенесено до параметрів.",
  go_to_preferences: "Перейти до параметрів",
  theme: "Тема",
  ...
  project_name_already_taken: "Назва проєкту вже використовується.",
  project_identifier_already_taken: "Ідентифікатор проєкту вже використовується.",
  ...
  deactivate_your_account_description:
    "Після деактивації вас не можна буде призначати на робочі одиниці, і з вас не стягуватиметься плата за робочий простір. Щоб знову активувати обліковий запис, потрібно отримати запрошення на цю електронну адресу.",
  ...
  settings_description:
    "Керуйте налаштуваннями облікового запису, робочого простору та проєкту в одному місці. Перемикайтеся між вкладками для швидкого налаштування.",
  back_to_workspace: "Повернутися до робочого простору",
  project_view: {
    sort_by: {
      created_at: "Створено",
      updated_at: "Оновлено",
  ...
  account_settings: {
    profile: {
      change_email_modal: {
        ...
        toasts: {
          success_title: "Успіх!",
          success_message: "Електронну пошту успішно оновлено. Увійдіть знову.",
        },
        form: {
          email: {
            ...
            errors: {
              required: "Електронна пошта є обов’язковою",
              invalid: "Електронна пошта недійсна",
              exists: "Електронна пошта вже існує. Використайте іншу.",
              validation_failed: "Не вдалося підтвердити електронну пошту. Спробуйте ще раз.",
            },
          },
          code: {
            label: "Унікальний код",
            placeholder: "123456",
            helper_text: "Код підтвердження надіслано на вашу нову електронну пошту.",
            errors: {
    ...
    preferences: {
      heading: "Параметри",
      description: "Налаштуйте досвід роботи з застосунком відповідно до ваших потреб",
    },
    notifications: {
      heading: "Сповіщення електронною поштою",
      description: "Будьте в курсі робочих одиниць, на які ви підписані. Увімкніть сповіщення.",
    },
    security: {
      heading: "Безпека",
    },
    api_tokens: {
      heading: "Персональні токени доступу",
      description: "Створюйте безпечні API-токени для інтеграції з зовнішніми системами та застосунками.",
    },
    activity: {
      heading: "Активність",
      description: "Відстежуйте останні дії та зміни у всіх проєктах і робочих одиницях.",
    },
  },
  workspace_settings: {
    ...
    settings: {
      general: {
        ...
        errors: {
          ...
          company_size: {
            ...
            select_a_range: "Виберіть діапазон розміру організації",
          },
        },
      },
      members: {
      ...
      exports: {
        heading: "Експорти",
        description: "Експортуйте дані проєкту у різних форматах і переглядайте історію експортів.",
        title: "Експорти",
        exporting: "Експортування",
        exporting_projects: "Експортування проєктів",
        previous_exports: "Попередні експорти",
        export_separate_files: "Експортувати дані в окремі файли",
        format: "Формат",
        filters_info: "Застосуйте фільтри для експорту конкретних робочих одиниць за вашими критеріями.",
        modal: {
  ...
  profile: {
    ...
    actions: {
      ...
      notifications: "Сповіщення",
      preferences: "Параметри",
      "api-tokens": "Персональні токени доступу",
    },
    tabs: {
      summary: "Зведення",
      assigned: "Призначено",
  ...
  project_settings: {
    ...
    states: {
      heading: "Стани",
      description: "Визначайте та налаштовуйте стани робочого процесу для відстеження прогресу.",
    ...
    labels: {
      heading: "Мітки",
      description: "Створюйте власні мітки для категоризації та організації робочих одиниць.",
    ...
    estimates: {
      ...
      description: "Вони допомагають повідомляти про складність і навантаження команди.",
      enable_description: "Допомагають комунікувати складність та навантаження команди.",
    ...
    features: {
      cycles: {
        title: "Цикли",
        short_title: "Цикли",
        description: "Плануйте роботу в гнучких періодах, що адаптуються до унікального ритму та темпу цього проєкту.",
      ...
      modules: {
        title: "Модулі",
        short_title: "Модулі",
        description: "Організуйте роботу в підпроєкти з визначеними керівниками та виконавцями.",
        toggle_title: "Увімкнути модулі",
        toggle_description: "Учасники проєкту зможуть створювати та редагувати модулі.",
      },
      views: {
        title: "Подання",
        short_title: "Подання",
        ...
        toggle_title: "Увімкнути подання",
        toggle_description: "Учасники проєкту зможуть створювати та редагувати подання.",
      },
      pages: {
        title: "Сторінки",
        ...
        toggle_description: "Учасники проєкту зможуть створювати та редагувати сторінки.",
      },
      intake: {
        title: "Надходження",
        short_title: "Надходження",
        description:
          "Дозвольте неучасникам ділитися помилками, відгуками та пропозиціями, не порушуючи робочий процес.",
        toggle_title: "Увімкнути надходження",
        toggle_description: "Дозволити учасникам проєкту створювати запити надходження у застосунку.",
      },
    },
  },
  project_cycles: {
  ...
  power_k: {
    contextual_actions: {
      work_item: {
        title: "Дії з робочою одиницею",
        indicator: "Робоча одиниця",
        change_state: "Змінити стан",
        change_priority: "Змінити пріоритет",
        change_assignees: "Призначити",
        assign_to_me: "Призначити мені",
        unassign_from_me: "Зняти призначення з мене",
        change_estimate: "Змінити оцінку",
        add_to_cycle: "Додати до циклу",
        add_to_modules: "Додати до модулів",
        add_labels: "Додати мітки",
        subscribe: "Підписатися на сповіщення",
        unsubscribe: "Скасувати підписку на сповіщення",
        delete: "Видалити",
        copy_id: "Копіювати ID",
        copy_id_toast_success: "ID робочої одиниці скопійовано до буфера обміну.",
        copy_id_toast_error: "Під час копіювання ID робочої одиниці сталася помилка.",
        copy_title: "Копіювати назву",
        copy_title_toast_success: "Назву робочої одиниці скопійовано до буфера обміну.",
        copy_title_toast_error: "Під час копіювання назви робочої одиниці сталася помилка.",
        copy_url: "Копіювати URL",
        copy_url_toast_success: "URL робочої одиниці скопійовано до буфера обміну.",
        copy_url_toast_error: "Під час копіювання URL робочої одиниці сталася помилка.",
      },
      cycle: {
        title: "Дії з циклом",
        indicator: "Цикл",
        ...
        remove_from_favorites: "Вилучити з вибраного",
        copy_url: "Копіювати URL",
        copy_url_toast_success: "URL циклу скопійовано до буфера обміну.",
        copy_url_toast_error: "Під час копіювання URL циклу сталася помилка.",
      },
      module: {
        title: "Дії з модулем",
        indicator: "Модуль",
        add_remove_members: "Додати/вилучити учасників",
        change_status: "Змінити статус",
        add_to_favorites: "Додати до вибраного",
        remove_from_favorites: "Вилучити з вибраного",
        copy_url: "Копіювати URL",
        copy_url_toast_success: "URL модуля скопійовано до буфера обміну.",
        copy_url_toast_error: "Під час копіювання URL модуля сталася помилка.",
      },
      page: {
        ...
        lock: "Заблокувати",
        unlock: "Розблокувати",
        make_private: "Зробити приватною",
        make_public: "Зробити публічною",
        archive: "Заархівувати",
        restore: "Відновити",
        add_to_favorites: "Додати до вибраного",
        remove_from_favorites: "Вилучити з вибраного",
        copy_url: "Копіювати URL",
        copy_url_toast_success: "URL сторінки скопійовано до буфера обміну.",
        copy_url_toast_error: "Під час копіювання URL сторінки сталася помилка.",
      },
    },
    creation_actions: {
      create_work_item: "Нова робоча одиниця",
      create_page: "Нова сторінка",
      create_view: "Нове подання",
      create_cycle: "Новий цикл",
      create_module: "Новий модуль",
      create_project: "Новий проєкт",
      create_workspace: "Новий робочий простір",
    },
    navigation_actions: {
      open_workspace: "Відкрити робочий простір",
      nav_home: "Перейти на головну",
      nav_inbox: "Перейти до вхідних",
      nav_your_work: "Перейти до вашої роботи",
      nav_account_settings: "Перейти до налаштувань облікового запису",
      open_project: "Відкрити проєкт",
      nav_projects_list: "Перейти до списку проєктів",
      nav_all_workspace_work_items: "Перейти до всіх робочих одиниць",
      nav_assigned_workspace_work_items: "Перейти до призначених робочих одиниць",
      nav_created_workspace_work_items: "Перейти до створених робочих одиниць",
      nav_subscribed_workspace_work_items: "Перейти до підписаних робочих одиниць",
      nav_workspace_analytics: "Перейти до аналітики робочого простору",
      nav_workspace_drafts: "Перейти до чернеток робочого простору",
      nav_workspace_archives: "Перейти до архівів робочого простору",
      open_workspace_setting: "Відкрити налаштування робочого простору",
      nav_workspace_settings: "Перейти до налаштувань робочого простору",
      nav_project_work_items: "Перейти до робочих одиниць",
      open_project_cycle: "Відкрити цикл",
      nav_project_cycles: "Перейти до циклів",
      open_project_module: "Відкрити модуль",
      nav_project_modules: "Перейти до модулів",
      open_project_view: "Відкрити подання проєкту",
      nav_project_views: "Перейти до подань проєкту",
      nav_project_pages: "Перейти до сторінок",
      nav_project_intake: "Перейти до надходжень",
      nav_project_archives: "Перейти до архівів проєкту",
      open_project_setting: "Відкрити налаштування проєкту",
      nav_project_settings: "Перейти до налаштувань проєкту",
    },
    account_actions: {
      sign_out: "Вийти",
      workspace_invites: "Запрошення до робочого простору",
    ...
    miscellaneous_actions: {
      toggle_app_sidebar: "Перемкнути бічну панель застосунку",
      copy_current_page_url: "Копіювати URL поточної сторінки",
      copy_current_page_url_toast_success: "URL поточної сторінки скопійовано до буфера обміну.",
      copy_current_page_url_toast_error: "Під час копіювання URL поточної сторінки сталася помилка.",
      focus_top_nav_search: "Фокус у полі пошуку",
    },
    preferences_actions: {
      update_theme: "Змінити тему інтерфейсу",
      update_timezone: "Змінити часовий пояс",
      update_start_of_week: "Змінити перший день тижня",
      update_language: "Змінити мову інтерфейсу",
      toast: {
        theme: {
          success: "Тему успішно оновлено.",
          error: "Не вдалося оновити тему. Спробуйте ще раз.",
        },
        timezone: {
          success: "Часовий пояс успішно оновлено.",
          error: "Не вдалося оновити часовий пояс. Спробуйте ще раз.",
        },
        generic: {
          success: "Параметри успішно оновлено.",
          error: "Не вдалося оновити параметри. Спробуйте ще раз.",
        },
      },
    },
    help_actions: {
    ...
    page_placeholders: {
      ...
      open_project_view: "Відкрити подання проєкту",
      open_project_setting: "Відкрити налаштування проєкту",
      update_work_item_state: "Змінити стан",
      update_work_item_priority: "Змінити пріоритет",
      update_work_item_assignee: "Призначити",
      update_work_item_estimate: "Змінити оцінку",
      update_work_item_cycle: "Додати до циклу",
      update_work_item_module: "Додати до модулів",
      update_work_item_labels: "Додати мітки",
      update_module_member: "Змінити учасників",
      update_module_status: "Змінити статус",
  ...
  customize_navigation: "Налаштувати навігацію",
  personal: "Особисте",
  accordion_navigation_control: "Акордеонна навігація бічної панелі",
  horizontal_navigation_bar: "Навігація вкладками",
  show_limited_projects_on_sidebar: "Показувати обмежену кількість проєктів на бічній панелі",
  enter_number_of_projects: "Введіть кількість проєктів",
  pin: "Закріпити",
  unpin: "Відкріпити",
} as const;
